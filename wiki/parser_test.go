...
_Именины_
- Амвросий, Аниан, Виктор, Мария, Поликарп, Серв(ус), Теодор, Юмбер, Августа, Александр, Алексей, Григорий, Евгений, Евграф, Екатерина, Ермоген, Иван, Корнелий и Корнилий, Марк, Мастридия, Меркурий, Митрофан, Михаил, Порфирий, Прокопий, Симон, Филофея, Филумен, Христофор
`
...
_Именины_
- Авив, Бон, Василий, Гамалиил, Гонорат, Екзуперанций, Иоанн (Иван), Калюмниоз, Кастел, Кирилл (Кирил), Мавр, Немезий, Никодим, Олимпий (Олимп), Олимпан, Платон, Примитиво, Роман, Симфоний, Стефан (Степан), Тарасий (имя), Теодол, Тертуллин, Фавст (Фауст), Феодор (Фёдор), Фока (Фокей, Фокан, Фок), Екзуперия, Люцилла
`
	s2 := report2.String()
	validateStrings(t, expected, s2)
}
