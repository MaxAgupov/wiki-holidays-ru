...
_«Введенье, Ворота зимы». Народ приметил, что в это время бывают морозы:_
«Введение накладывает на воду ледение»
«На Введение — толстое леденье»
«Введение пришло — зиму привело»
«Введенские морозы зиму на ум наставляют»
...
_Романов день. Роман Чудотворец._
На Романа рыбы ложатся в свои зимовальные ямы, на дно
По тучам да по звездам гадают о будущей погоде
Если на заре лицом к северному ветру встать, то сметет он с тебя все надсады, все тяготы
В это время у лосей отпадают старые рога, а в берлоге засыпает медведь
...
_Андреева ночь. Гадальный день. Святой Андрей. Андрей Первозванный._
В старину на Андрея наслушивали воду: поутру шли на реку, рубили прорубь, прежде чем зачерпнуть воды, опускались на колени на краю проруби, прижимались ухом ко льду и слушали:Когда шумная вода, то надо ждать метели, стужи
Когда тихая вода на Андреев день, то зима будет тихой, хорошей
`
	s2 := report2.String()
...
func TestParse_12_04(t *testing.T) {
	//location, _ := time.LoadLocation("Europe/Moscow")
	//now := time.Date(2019, time.April, 12, 1, 1, 1, 1, location)
	//fullReport := getWikiReport(&now)
	//fmt.Print(fullReport)
...
=== Национальные ===
 Либерия — Национальный день освобождения (1980).


=== Профессиональные ===
 Казахстан — День работников науки.
 Белоруссия,  Россия — День космонавтики.
 Украина — День работников ракетно-космической отрасли Украины.
...
_Именины_
- Аполлос, Еввула, Епафродит, Зенон, Зосима, Кесарь, Кифа, Иван, Иоад, Сосфен, Софрон, Виктор, Людослав, Юлиан

*Приметы*

_Беды с домовым. Иоанн Лествичник. Простины Беломорья (северн.)._
В этот день полагалось печь из теста лесенки — для будущего восхождения на небо
Домовой бесится до полуночи и, пока не запоёт петух, не узнаёт своих домашних. Поэтому ходить на двор в этот день было нежелательно
Средний срок начала тяги вальдшнепов; если вдруг тяга прекращается — жди скорого похолодания
`
...
func TestParse_30_04(t *testing.T) {
	//location, _ := time.LoadLocation("Europe/Moscow")
	//now := time.Date(2019, time.April, 30, 1, 1, 1, 1, location)
	//fullReport := getWikiReport(&now)
	//fmt.Print(fullReport)
...
=== Национальные ===
 Вьетнам — День победы.
 Иран — Национальный день Персидского залива.
 Мексика — День ребёнка.
 Россия — День пожарной охраны.
 Швеция — День Короля.
...
память Адъютора (Аютора) Вернонского (1131);
память Эмо Савиньиского (1173);
память святых Аматора, Питера и Луиса (Людовика) (855);
память святых Афродисия и его тридцати спутников;
память святого Евтропия Сентского;
память блаженного Майлса Джерарда (1590);
память Вольфарда Аугсбургского (1127);
...
_Религиозные_
- Вальпургиева ночь (языч.)

_Именины_
- Адъютора, Аютор, Аматор, Афродисий, Вольфард, Евтропий, Квиринус, Луис, Людовик, Майлс, Максим, Мария, Пий, Питер, Пётр, Помпоний, Свитберт, Хильдегарда, Эмо, Авделай, Агапит, Адриан, Азат, Акакий, Александр, Анания, Аскитрея, Симеон, Усфазан, Фусик, Хусдазад
`
	s2 := report2.String()
	validateStrings(t, expected, s2)
}
...
празднования в честь икон Божией Матери:«Одигитрия» Югская (1615);
«Одигитрия» Выдропусская (XV в.);
«Одигитрия» Костромская (1672);
«Одигитрия» Седмиезерная (XVII в.);
Гребневская (1380);
«Одигитрия» Супрасльская (XVI в.);
...
«Одигитрия» Христофоровская (XVI в.);
«Умиление» Серафимо-Дивеевская (1885);
«Одигитрия» Воронинская (1524);
...
_Тихон-страстной. Максим-исповедник. Спасовские деды. Окончание праздника Преображения._
В этот день прибирались в сараях и погребах, чтобы к зимним хранилищам не привились осенние гнили
Коли грибовно, так и хлебовно
Грачи устраивают пробные облёты
Ветры дуют тихо — к вёдру, а бурей проносятся — быть дождливому сентябрю
...
_Фрол и Лавёр — лошадники, Лошадиный праздник, Конский праздник, День Фрола и Лавра, День лошадника, Дожинки и досевки, Хлебный день, «Рабінавая ноч» (белорус.), «Гарабінава ноч» (белорус.), «Капыты» (белорус.), Фролки (костром.), Флор и Лавр._
День Фрола и Лавра, покровителей лошадей
На лошадях не работать, чтоб падежа не было
Сей озимь от Преображения до Флора, чтоб не было флёровых цветиков
С Флёрова дня засиживают ретивые, а с Семёна — ленивые
...
func TestParse_3_09(t *testing.T) {
	//location, _ := time.LoadLocation("Europe/Moscow")
	//now := time.Date(2019, time.September, 3, 1, 1, 1, 1, location)
	//fullReport := getWikiReport(&now)
	//fmt.Print(fullReport)
...
=== Национальные ===
 Австралия — День флага.
 Иран — День борьбы с английской интервенцией.
 Катар — День независимости.
 Китай — День Победы над Японией.
 Россия — День победы над Японией, День солидарности в борьбе с терроризмом.
 СССР— День победы над Японией
 Сан-Марино — День основания республики.
 Тунис — День движения за независимость.


=== Профессиональные ===
 Канада — День торгового флота
 Молдавия — День Национальной армии.
 Китайская Республика — День вооружённых сил Тайваня


=== Религиозные ===
 Православиепамять апостола от 70-ти Фаддея (ок. 44);
память мученицы Вассы и чад ее, мучеников Феогния, Агапия и Писта (305—311);
...
празднование в честь Светописанной (Светописанный образ) иконы Божией Матери.Католици́зм или католи́чество
...
МужскиеАвраамий (Авраам, Аврамий):
преподобный Авраамий Палеостровский;
Авраамий трудолюбивый, Печерский;
преподобный Авраамий Смоленский;
Агапий — мученик Агапий Эдесский;
Александр:
мученик Александр;
священномученик Александр (Елоховский);
Дорофей мученик Дорофей;
Ефрем — преподобный Ефрем Смоленский;
Игнатий — преподобномученик Игнатий (Даланов);
Иоанникий — мученик Иоанникий;
Корнилий — Корнилий ПалеДионисийский, Олонецкий, игумен
Павел — священномученик Павел (Ягодинский);
Пист — мученик Пист Эдесский;
Сармеан — Сармеан, патриарх-католикос Грузинский
Фаддей — Фаддей, апостол от 70-ти;
Феогний — мученик Феогний Эдесский;ЖенскиеВасса — мученица Васса Алонская;
Марфа — преподобная Марфа Дивеевская (Милюкова);
Феоклита — преподобная Феоклита.
`
...
_Религиозные_
- память апостола от 70-ти Фаддея (ок. 44) (правосл.)

_Именины_
- Авраамий, Авраам, Аврамий, Печерский, Агапий, Александр, Ефрем, Игнатий, Иоанникий, Корнилий, Павел, Пист, Сармеан, Фаддей, Феогний, Васса, Марфа, Феоклита
`
	s2 := report2.String()
	validateStrings(t, expected, s2)
}
...
_Сергей-капустник. Сергей-курятник. Сергий Радонежский._
На Сергея капусту рубят
Сергей — курятник: кур бьют на продажу
Если первый снег на Сергия, то зима установится на Михайлов день (8/21 ноября)
Зимний путь устанавливается в четыре семины (седьмицы) от Сергия
...
_Трифон и Пелагея. Починки. Ознобицы. Зябушка. Ознобуха. Зима забирает._
С Трифона и Пелагеи все холоднее
Трифон шубу чинит, Пелагея рукавицы шьёт
Худо, коли зима врасплох застанет, шапкой с ног свалит.В этот день принято заниматься починкой, изготовлением или приобретением зимней одежды, готовясь к наступающей зиме
`
...
func TestParse_31_10(t *testing.T) {
	//location, _ := time.LoadLocation("Europe/Moscow")
	//now := time.Date(2019, time.October, 31, 1, 1, 1, 1, location)
	//fullReport := getWikiReport(&now)
	//fmt.Print(fullReport)
...
_Религиозные_
- День Реформации (лютер)
- память апостола и евангелиста Луки (I век) (правосл.)
`
...
_Конюхов день. Конюхам отдых. Грязнихи. Садок. Иван._
Святой Садок — избавитель от напрасной (без покаяния и исповеди, нелепой) смерти
Путь груден — коню запряженному труден. И потому давали конюхи в этот день коням отдохнуть
Конюхам отдых, коням — роздых
`
...
func TestParse_6_11(t *testing.T) {
	//location, _ := time.LoadLocation("Europe/Moscow")
	//now := time.Date(2019, time.November, 6, 1, 1, 1, 1, location)
	//fullReport := getWikiReport(&now)
	//fmt.Print(fullReport)
...
=== Национальные ===
 Доминиканская Республика — День Конституции.
 Таджикистан — День Конституции.
 Татарстан — День Конституции.
 Узбекистан — День работника культуры.
 Финляндия — День шведской культуры.


=== Религиозные ===
 В католической церквипамять Леонарда, отшельника Лиможского (VI век).
 В православной церквипразднование иконы Божьей Матери «Всех скорбящих Радость» (1688 год);
...
память мученицы Синклитикии и двух дощерей её (VI век);
...
_Матрёнин день. Матрёны зимние._
Зима вступает в свои права, наступают морозы
Если деревья покроет иней — будут морозы
Туман в Матрёнин день — к оттепели
Коли погода на Матрёну облачная и снежная — быть ненастному маю
